{
  ...
  activeadmin = {
    ...
    source = {
      ...
      rev = "475d2ad9bbbff247027ea0f1ebc0bc511d672e54";
      sha256 = "0b7cg7glkjwibbrygmfkvcrarr36q2wv95d6gimgibawxy75k8mv";
      type = "git";
  ...
  recaptcha = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1ksnw0mb5wwa8s43whb2imzy389zlrc9axz9b4xy6kwx6lnc5gy3";
      type = "gem";
    };
    version = "4.13.2";
  };
